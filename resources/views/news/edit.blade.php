    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">EDITING NEWS</div>
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" method="POST" action="{{ url('/editingnews', array($newss->id)) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('news_title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="news_title" type="text" class="form-control" name="news_title" value="{{ $newss->news_title }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('news_body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="news_body" type="text" rows="7" class="form-control" name="news_body"  required autofocus>{{$newss->news_body}}</textarea>
